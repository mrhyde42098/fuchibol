  ...
  return (
    <section className="mb-4 rounded-2xl bg-gradient-to-b from-white/[0.04] to-transparent p-4 ring-1 ring-white/[0.06]">
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        <p className="hidden text-[10px] text-white/30 sm:block">Solo señales verificadas · desliza →</p>
      </div>

      {channels.length === 0 ? (
        <p className="py-6 text-center text-xs text-white/35">
          Verificando canales con señal activa… aparecerán aquí automáticamente.
        </p>
      ) : (
